...
const variantStyles = {
  ...
  icon: "bg-transparent [&>svg]:size-5 p-1.5 [&>svg]:text-foreground border-transparent border hover:border-primary-foreground hover:shadow-xs hover:[&>svg]:text-primary rounded-md!",
};
