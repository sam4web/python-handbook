...
export default function CheatsheetItem({ cheatsheet }: { cheatsheet: ICheatsheetItem }) {
  ...
  return (
    <div className="bg-muted/60 px-2 md:px-3.5 pt-2 pb-3 md:pb-4 rounded-xl shadow-sm relative border-2 border-transparent hover:border-primary hover:-translate-y-1 group">
      <div className="mb-3">
